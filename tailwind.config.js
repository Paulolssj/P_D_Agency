...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "fluid-h1": ["clamp(2.5rem, 10vw, 10rem)", { lineHeight: "1.05", letterSpacing: "-0.04em", fontWeight: "900" }],
        "fluid-h2": ["clamp(2rem, 8vw, 6.5rem)", { lineHeight: "1.05", letterSpacing: "-0.03em", fontWeight: "900" }],
