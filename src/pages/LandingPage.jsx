            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center mb-14">
              ...
              <div className="lg:col-span-7 space-y-6 text-left">
                ...
                <motion.h1 
                  ...
                  className={`font-headline text-5xl xs:text-6xl sm:text-7xl md:text-8xl lg:text-[100px] font-black uppercase leading-[0.98] sm:leading-[0.92] tracking-[-0.035em] text-center lg:text-left ${
                    darkMode ? 'text-white' : 'text-neutral-900'
                  }`}
                >
